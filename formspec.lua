...
return button(9,0,"vbots_gui_run.png","run",true)
        ...
        .."tooltip[13,0;1,1;Stop/Remove all your bots]"
        ..button(14,0,"vbots_gui_reset.png","reset")
        ..button(11,0,"vbots_gui_load.png","load",true)
        ..button(12,0,"vbots_gui_save.png","save",true)
        ..highlight(9,0,1,1,"5","5","f")
        ..highlight(13,0,2,1,"5","5","f")
...
--           .."listring[detached:bottrash;main]"
           ...
           ..button(15,1.5,"vbots_fm.png","sub_0")
           ..button(15,2.5,"vbots_f1.png","sub_1")
           ..button(15,3.5,"vbots_f2.png","sub_2")
           ..button(15,4.5,"vbots_f3.png","sub_3")
           ..button(15,5.5,"vbots_f4.png","sub_4")
           ..button(15,6.5,"vbots_f5.png","sub_5")
           ..button(15,7.5,"vbots_f6.png","sub_6")
...
local function get_formspec(pos,meta)
    ...
    local formspec = "size[16,9.3]"
                     ...
                     .."❄" .. shot_lv .. " " .. string.format("%.1f", shot) .. "/42  "
                     .."♥" .. hp_cap .. "/" .. hp_cap .. "  "
                     .."▣ " .. armor .. "/5  "
                     .."]"
...
-------------------------------------
function vbots2.show_formspec(clicker,pos)

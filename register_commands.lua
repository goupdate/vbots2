...
register_command("mode_build","build_front","vbots_mode_build.png")
register_command("build_behind","build_behind","vbots_build_behind.png")
register_command("move_up","Move up one block","vbots_move_up.png")
